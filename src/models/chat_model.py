...
class OpenAIBase:
    ...
    def _stream_response(self, messages):
        try:
            ...
            err = f"Error streaming response: {type(e).__name__}; URL: {self.base_url}; Model: {self.model_name}"
            logger.error(err)
            raise Exception(err)
...
class DashScope(OpenAIBase):
    ...
    def _stream_response(self, messages):
        ...
        try:
            ...
            msg = f"DashScope stream error: {type(e).__name__}; Model: {self.model_name}"
            logger.error(msg)
